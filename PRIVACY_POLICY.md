...
We collect personal information that you voluntarily provide to us when you register on the application, express an interest in obtaining information about us or our products and Services, or when you participate in activities on the application (such as sending messages through our messaging server). 
...
* **Personal Data:** Names, phone numbers, email addresses, and contact preferences.
* **Service Data:** Messaging templates, communication logs, client contact lists, and any content sent via our WhatsApp integration or messaging server.
* **Usage Data:** Diagnostic data, log files, and analytics related to your use of the application.

## 2. How We Use Your Information

We use the information we collect or receive:
* **To facilitate account creation and logon process.**
* **To provide and manage our Services:** Including executing message blasts, maintaining your contact lists, and processing templates.
* **To send administrative information to you:** Such as updates regarding our terms, conditions, and policies.
...
* **Third-Party Service Providers:** We may share your data with third-party vendors, such as WhatsApp/Meta APIs for the purpose of executing the messaging services.
